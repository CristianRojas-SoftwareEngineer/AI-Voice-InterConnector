...
**AI Voice InterConnector 0.22.0** se distribuye bajo la licencia
...
- **Código fuente (tarball del tag):**
  <https://github.com/CristianRojas-SoftwareEngineer/AI-Voice-InterConnector/archive/refs/tags/v0.22.0.tar.gz>
- **Release v0.22.0 (artefactos y notas):**
  <https://github.com/CristianRojas-SoftwareEngineer/AI-Voice-InterConnector/releases/tag/v0.22.0>
