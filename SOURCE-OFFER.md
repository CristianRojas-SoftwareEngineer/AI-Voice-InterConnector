...
**TTS Sidecar 0.10.2** se distribuye bajo la licencia
...
- **Código fuente (tarball del tag):**
  <https://github.com/CristianRojas-SoftwareEngineer/TTS-Sidecar/archive/refs/tags/v0.10.2.tar.gz>
- **Release v0.10.2 (artefactos y notas):**
  <https://github.com/CristianRojas-SoftwareEngineer/TTS-Sidecar/releases/tag/v0.10.2>
