...
- [3. Captura push-to-talk (`--mic` sin `--duration`)](#3-captura-push-to-talk---mic-sin---duration)
  - [3.1 Superficie de flags](#31-superficie-de-flags)
  - [3.2 Matriz de comportamiento con `--mic`](#32-matriz-de-comportamiento-con---mic)
  - [3.3 Reglas de validación (previas, puras — P1/P2)](#33-reglas-de-validación-previas-puras--p1p2)
  - [3.4 Contrato de push-to-talk](#34-contrato-de-push-to-talk)
  - [3.5 Canales y exit codes](#35-canales-y-exit-codes)
- [4. Revisión interactiva de síntesis (`--play`)](#4-revisión-interactiva-de-síntesis---play)
  - [4.1 Precondiciones (previas a sintetizar — P1)](#41-precondiciones-previas-a-sintetizar--p1)
  - [4.2 Flujo del bucle](#42-flujo-del-bucle)
  - [4.3 Revalidación de colisión de etiqueta (crítico)](#43-revalidación-de-colisión-de-etiqueta-crítico)
  - [4.4 Invariantes de eficiencia](#44-invariantes-de-eficiencia)
  - [4.5 Efectos observables](#45-efectos-observables)
- [5. Diseño de implementación (Rust)](#5-diseño-de-implementación-rust)
  - [5.1 Captura push-to-talk (`crates/avi-audio`)](#51-captura-push-to-talk-cratesavi-audio)
  - [5.2 Selector en las cuatro vías (`src/main.rs`)](#52-selector-en-las-cuatro-vías-srcmainrs)
  - [5.3 Bucle de revisión de síntesis (`src/main.rs`)](#53-bucle-de-revisión-de-síntesis-srcmainrs)
