...
- **Relaciones**: espeja el precedente de H-09 (deuda del oráculo Python migrado, cerrada por saneo documental); H-07 se resolvió por su cuenta (restauración de la precarga en caliente, 2026-09-20), sin haber compartido sesión de decisión con H-06.
...
- **Impacto resuelto**: los 7 docs describen la superficie y el flujo Rust reales; los gaps de contrato aún pendientes (H-08 `--mic` sin `--duration`, H-10 `list --voice`, H-12 `--play`) quedan documentados como comportamiento real, sin prometer features inexistentes ni confundirse con divergencias deliberadas.
...
5. **H-12 última** — requiere la decisión de H-08 (aún pendiente) y ciclo de vida estable.
