...
- Tests pytest (729 tests: timing, protocolo, daemon, CLI, voces, rutas, caché de modelo, audio, traducción, Cask y utilidades de build), más los smoke-tests de instaladores (bats Linux/macOS y Pester Windows) en CI
